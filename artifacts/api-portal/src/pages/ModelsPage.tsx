...
export const OPENROUTER_MODELS: ModelEntry[] = [
  ...
  { id: "x-ai/grok-4.20-multi-agent", label: "Grok 4.20 Multi-Agent", provider: "openrouter", desc: "多 Agent 增强版 Grok，适合复杂分工推理与多步骤任务", context: "256K", badge: "tools" },
  { id: "x-ai/grok-code-fast-1", label: "Grok Code Fast 1", provider: "openrouter", desc: "xAI 面向编码场景的高速模型，适合补全、修复与代码问答", context: "256K", badge: "tools" },
  ...
  { id: "qwen/qwen3-coder-next", label: "Qwen 3 Coder Next", provider: "openrouter", desc: "Qwen 最新编程向模型，偏重代码生成、重构与调试", context: "128K", badge: "tools" },
  { id: "google/gemini-2.5-pro", label: "Gemini 2.5 Pro (OR)", provider: "openrouter", desc: "通过 OpenRouter 转发的 Gemini 2.5 Pro", context: "1M" },
  { id: "google/gemini-3.1-pro-preview", label: "Gemini 3.1 Pro Preview (OR)", provider: "openrouter", desc: "通过 OpenRouter 转发的 Gemini 3.1 Pro 预览模型", context: "2M", badge: "tools" },
  ...
  { id: "anthropic/claude-opus-4.7", label: "Claude Opus 4.7 (OR)", provider: "openrouter", desc: "通过 OpenRouter 转发的更新版 Claude Opus，适合高难度推理与代码任务", context: "1M", badge: "tools" },
